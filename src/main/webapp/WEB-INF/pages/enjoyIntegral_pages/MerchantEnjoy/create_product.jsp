...
<body class="claro" >
    <div id="dqwz">
		<p>
			当前位置：业务管理&nbsp;〉&nbsp;<%=ProductEnjoy.TABLE_ALIAS%>新增
		</p>
		<p class="line"></p>
	</div>
 
  <mvc:form id="form1" name="form1" action="addProduct.do"
		...
		<div class="biao">
	     <table class="grid">
		    ...
		    <tr>
			   ...
			   <td >
		             <input data-dojo-type="dijit.form.ValidationTextBox" id="integralValue" maxlength="20" name="integralValue"
							data-dojo-props="trim:true,required:true,regExp:'^([1-9]([0-9]+)?(\.[0-9]{1,2})?)|((0){1})|([0-9]\.[0-9]([0-9])?)$',invalidMessage:'请输入整数或小数(小数点后保留两位)'"
			   ...
			   <td >
		             <textarea cols="29" id="remark" name="remark" data-dojo-type="net.yutuo.dojo.Textarea" maxlength="100">${model.remark}</textarea>
		       </td>
        
         </tr>
          <tr>
		       <td class="lgridlist">
			       <%=ProductEnjoy.ALIAS_GIFT_COUNT%>:
		       </td>
			   <td >
               ...
               <td class="lgridlist">
			       <%=ProductEnjoy.ALIAS_IS_GROUND%>:
		       </td>
			   <td>
			        <mytag:select dictName="D_PRODUCT_STATE"
									id="isGround" value="${model.isGround}" name="isGround" notEmpty="true"/>
	     ...
	     <table class="b">
			<tr align="center">
				<td width="200px"></td>
				<td><input type="submit" style="width: 80px" value="添加"/></td>
