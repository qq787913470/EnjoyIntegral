    ...
    <div class="biao" id="mainContent">
        <div data-dojo-type="dijit/Dialog" data-dojo-id="myDialog"
            ...
            <mvc:form id="queryForm" name="queryForm" action="changeMerchanState.do"
                ...
                <table class="grid">
                    <input type="hidden" name="merNo" value="${merchantBase.merNo}"/>
                    <input type="hidden" name="serviceStare"
                           <c:if test="${merchantBase.serviceStare == '0'}">value="1"</c:if>
                           <c:if test="${merchantBase.serviceStare == '1'}">value="0"</c:if>
                    />
                    <tr>
                        <td class="lgridlist">商户：</td>
                        <td><input value="${merchantBase.merName}"  readonly="readonly"></td>
                    </tr>
                    <tr>
