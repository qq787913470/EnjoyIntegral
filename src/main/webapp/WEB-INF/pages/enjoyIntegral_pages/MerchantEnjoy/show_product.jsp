...
<fieldset style="margin: 10px 0;padding: 10px;border: #DDD 1px solid" >
    <legend><%=ProductEnjoy.TABLE_ALIAS%>编辑</legend>
    <mvc:form action="updateProduct.do" theme="simple"  method="post" data-dojo-type="dijit.form.Form" id="form1" enctype="multipart/form-data">
        ...
        <table class="grid">
            ...
            <tr>
                ...
                <td >
                    <input data-dojo-type="dijit.form.ValidationTextBox" id="productName" maxlength="32" name="productName" data-dojo-props="trim:true,required:true" readonly= "true" value="${model.productName}"/>
                    <span style="color: red" id="productNameMess">*</span>
                </td>
                <td colspan="2" rowspan="2">
                    <c:if test="${model.picPath !=null}">
                        <img id="imgPre" border=0 src='../merchantbase/showImage.do?pic_addr=${model.picPath}' width="200" height="200">
                        <br/>
                    </c:if>
                    <c:if test="${model.picPath ==null}">
            ...
            <tr>
                ...
                <td >
                    <input readonly= "true" data-dojo-type="dijit.form.ValidationTextBox" id="price" maxlength="20" name="price"
            ...
            <tr>
                ...
                <td >
                    <input readonly= "true" data-dojo-type="dijit.form.ValidationTextBox" id="integralValue" maxlength="20" name="integralValue"
                           data-dojo-props="trim:true,required:true,regExp:'^([1-9]([0-9]+)?(\.[0-9]{1,2})?)|((0){1})|([0-9]\.[0-9]([0-9])?)$',invalidMessage:'请输入整数或小数(小数点后保留两位)'"
            ...
            <tr>
                <td class="lgridlist"><%=ProductEnjoy.ALIAS_GIFT_COUNT%>:</td>
                <td colspan="3">
                    <input data-dojo-type="dijit.form.ValidationTextBox" id="giftCount" maxlength="6" name="giftCount"
                           data-dojo-props="trim:true,required:true,regExp:'^[1-9][0-9]*$',invalidMessage:'请输入整数'"
                           value="${model.giftCount}" readonly= "true"/>
            ...
            <tr>
                ...
                <td >
                    <input id="endDate" name="endDate" value="${model.endDate}"
                           class="Wdate" type="text" readonly= "true" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
