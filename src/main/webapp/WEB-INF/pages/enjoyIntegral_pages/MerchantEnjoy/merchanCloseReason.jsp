...
<div id="content" style="visibility: hidden;">
    <div class="biao" id="mainContent">
        <div data-dojo-type="dijit/Dialog" data-dojo-id="myDialog"
            ...
            <mvc:form id="queryForm" name="queryForm" action="changeMerchanState.do"
                      method="post" style="display: inline;">
                <table class="grid">
                    <input type="hidden" name="merNo" value="${merchantEnjoy.merNo}"/>
                    <input type="hidden" name="serviceStare"
                           <c:if test="${merchantEnjoy.serviceStare == '0'}">value="1"</c:if>
                           <c:if test="${merchantEnjoy.serviceStare == '1'}">value="0"</c:if>
                    />
                    <tr>
                        <td class="lgridlist">商户：</td>
                        <td><input value="${merchantEnjoy.merName}"  readonly="readonly"></td>
                    </tr>
                    <tr>
                ...
                <table class="b">
                    <tr align="center">
                        <td width="200px"></td>
                        <td><input id="submitButton" name="submitButton" style="width: 80px" type="submit"
                                   value="保存" /></td>
                    </tr>
                    <tr align="center">
                        <td width="200px"></td>
