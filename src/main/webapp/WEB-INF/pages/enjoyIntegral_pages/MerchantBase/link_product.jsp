	...
	<div id="content">
		...
		<div class="biao">
	     <table class="grid">
			   ...
			   <td >
		             <input id="productName" maxlength="128" name="productName" data-dojo-type="dijit.form.ValidationTextBox" data-dojo-props="trim:true,required:false" value="${model.productName}"/>
			   ...
			   <td >
		             <input id="price" maxlength="20" name="price" data-dojo-type="dijit.form.ValidationTextBox" data-dojo-props="trim:true,required:false,regExp:'^([1-9]([0-9]+)?(\.[0-9]{1,2})?)|((0){1})|([0-9]\.[0-9]([0-9])?)$',invalidMessage:'请输入整数或小数(小数点后保留两位)'" value="${model.price}"/>
		    ...
		    <tr>
			   ...
			   <td >
		             <input id="integralValue" maxlength="20" name="integralValue" data-dojo-type="dijit.form.ValidationTextBox"  data-dojo-props="trim:true,required:false,regExp:'^([1-9]([0-9]+)?(\.[0-9]{1,2})?)|((0){1})|([0-9]\.[0-9]([0-9])?)$',invalidMessage:'请输入整数或小数(小数点后保留两位)'" value="${model.integralValue}"/>
