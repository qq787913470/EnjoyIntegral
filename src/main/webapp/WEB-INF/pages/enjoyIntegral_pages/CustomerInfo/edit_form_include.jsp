...
<%@page import="com.yada.enjoyIntegral.model.*" %>
	...
	<input type="hidden" name="" value="${model.customerNo}" />
		    ...
		    <tr>
			   ...
			   <td >
		             <input data-dojo-type="dijit.form.ValidationTextBox" id="certificateNo" maxlength="20" name="certificateNo" data-dojo-props="trim:true,required:true" value="${model.certificateNo}" readonly="readonly"/> 
