...
<%@page import="com.yada.enjoyIntegral.model.*" %>
		    ...
		    <tr>
			   ...
			   <td >
		             <input data-dojo-type="dijit.form.ValidationTextBox" id="merNo" maxlength="15" name="merNo" data-dojo-props="trim:true,required:true,regExp:'^\[0-9]{15}$', invalidMessage:'请输入15位数字作为商户号.'" value="${model.merNo}" onblur="isMerNoExist(this.value);"/> 
	...
	<td>
		<select id="orgId" name="orgId">
			...
			<c:forEach  items="${ListOrgId}" var="item">
			   ...
			   <td >
		             <textarea rows="3" cols="6" id="contactAddr" name="contactAddr" maxlength="64">${model.contactAddr}</textarea>
		             <span style="color: red">*</span>
