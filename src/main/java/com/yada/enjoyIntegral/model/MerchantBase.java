...
public class MerchantBase {
	...
	//alias
	public static final String TABLE_ALIAS = "普通积分商户";
	...
	private List productBases = new ArrayList(0);
	public void setProductBases(List<ProductBase> productBases){
	...
	public boolean equals(Object obj) {
		if(obj instanceof MerchantBase == false) return false;
		if(this == obj) return true;
		MerchantBase other = (MerchantBase)obj;
