...
<div id="dqwz">
    <p>
        当前位置：报表管理&nbsp;〉&nbsp;   <%=OrgChangeSumReport.TABLE_ALIAS%>
</p>
    </p>
    <p class="line"></p>
</div>
<mvc:form id="queryForm" name="queryForm" action="list.do"
    ...
    <div id="content">
        <div class="biaoti">
            <p>
                <b><%=OrgChangeSumReport.TABLE_ALIAS%></b>
            </p>
        </div>
        <div class="biao">
            <table class="grid">
                <tr>
                    <td class="lgridlist"><%=OrgChangeSumReport.MER_NO%>:</td>
                ...
                <tr>
                    <td class="lgridlist"><%=OrgChangeSumReport.TRAN_DATE%>:</td>
                    ...
                    <td class="lgridlist"><%=OrgChangeSumReport.ORG_NAME%>:</td>
                    <td>
        ...
        <div class="form">
            <div id="eXtremeTable" class="eXtremeTable">
                ...
                <table class="grid its">
                    <thead>
                    <tr>
                        <th><%=OrgChangeSumReport.MER_NO%></th>
                        <th><%=OrgChangeSumReport.MER_NAME%></th>
                        <th><%=OrgChangeSumReport.ALLAMT%></th>
                        <th><%=OrgChangeSumReport.ALLCOUNT%></th>
                        <th><%=OrgChangeSumReport.ORG_NAME%></th>
                        <th><%=OrgChangeSumReport.ORG_ID%></th>
                        <th><%=OrgChangeSumReport.P_ORG_ID%></th>
                        <th><%=OrgChangeSumReport.P_ORG_NAME%></th>
                        <th><%=OrgChangeSumReport.TRAN_DATE%></th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <c:forEach items="${page.result}" var="item" varStatus="status">
                        <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
                            ...
                            <td><c:out value='${item.allAmt}'/>&nbsp;</td>
                            <td><c:out value='${item.allCount}'/>&nbsp;</td>
                    ...
                    <c:if test="${countIntegralValue !=  0.0}">
                        <tr>
                            <td style="text-align: right" colspan="5">积分消费总数：</td>
                            <td style="text-align: left" colspan="4">${countIntegralValue}</td>
                        </tr>
                    </c:if>
                    </tbody>
                </table>
